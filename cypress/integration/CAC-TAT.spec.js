...
this.beforeEach(function(){
    ...
    it('preenche os campos obrigatorios e emvia o formulário', function(){
        const longText = 'Teste, teste, teste,teste,teste,teste,teste,teste,teste,teste,teste,testeteste,teste,teste,.'
...
.should('have.value', '')
cy.get('#email')
.type('kleber@example.com')
.should('have.value', 'kleber@example.com')
.clear()
.should('have.value', '')
cy.get('#phone')
.type('1234567890')
